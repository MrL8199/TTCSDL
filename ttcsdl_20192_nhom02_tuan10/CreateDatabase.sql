...
CREATE TABLE KESACH
(
    MaKeSach INT NOT NULL PRIMARY KEY,
...
CREATE TABLE VIPHAM
(
    MaViPham INT NOT NULL PRIMARY KEY,
...
(
    MaDauSach INT NOT NULL PRIMARY KEY,
...
(
    MaCuonSach INT NOT NULL PRIMARY KEY,
...
CREATE TABLE CT_PHIEUMUON(
    MaCuonSach INT FOREIGN KEY REFERENCES CUONSACH(MaCuonSach),
    MaPhieuMuon INT FOREIGN KEY REFERENCES PHIEUMUON(MaPhieuMuon),
    PRIMARY KEY(MaCuonSach, MaPhieuMuon)
)

CREATE TABLE PHIEUTRA
(
    MaPhieuTra INT NOT NULL PRIMARY KEY,
    NgayTra DATE,
    MaThe INT FOREIGN KEY REFERENCES THETHUVIEN(MaThe)
)
...
CREATE TABLE CT_PHIEUTRA(
    ...
    PRIMARY KEY(MaCuonSach, MaPhieuTra)
)
